...
import Tron from "../assets/png/tronLogo.png";

const ConnectWallet = ({
  handleAuthenticate,
  handleUAuthenticate,
  handleCBAuthenticate,
  handleTronAuthenticate,
}) => {
  return (
    <section id="sign-in" className="text-gray-600 body-font">
      <div className="container max-w-xl py-12 mx-auto">
        ...
        <div className="flex w-full justify-center">
          ...
          <button
            onClick={handleTronAuthenticate}
            className="flex-shrink-0 flex text-cadet hover:bg-[#5694db] hover:bg-opacity-5 border-[#5694db] border py-1 px-3 focus:outline-none rounded text-lg mt-10 sm:mt-0 ml-2"
          >
            <img src={Tron} className="w-7" />
          </button>
        </div>
      </div>
    </section>
