      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-20">
          ...
          <h3 className="lg:w-2/3 max-w-lg mx-auto leading-relaxed text-base">
            Please switch to the <span className="font-bold">Shasta net</span>{" "}
                  ...
                  {error ? (
                    ...
                    <>
                      ...
                      <a
                        ...
                        href={`https://shasta.tronscan.org/#/transaction/${hash}`}
                        target="_blank"
                      >
                        {`https://https://shasta.tronscan.org/#/transaction/${hash}`.slice(
                          0,
                          40
                        )}
                        ...
